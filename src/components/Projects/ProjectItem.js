...
import openlink from "../asset/svg/external-link.svg";
    ...
    return (
        <Card className={classes.projectItem}>
            ...
            <div className={classes.controls}>
                ...
                <div className={classes.livelink}>
                    <a target="_blank" rel="noreferrer" href={props.project.livelink} style={{ color: nonThemeColor }}>
                    <img src={openlink} alt="" srcset="" />
                    </a>
                </div>
